 ...
 * @Author: zhangyong
 * @Date: 2017/10/12
 * @Description: 通知公告关联警察实体类
 */
public class NoticePolice {
    /**
     *表ID
     */
    private Integer id;
    ...
    public Date getSeeFlagTime() {
        return seeFlagTime;
    }

    public void setSeeFlagTime(Date seeFlagTime) {
        this.seeFlagTime = seeFlagTime;
    }
