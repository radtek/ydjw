 ...
 * @date 2017/11/30
 */
public class ExplosiveMaterialEntity implements Serializable {


	private static final long serialVersionUID = -8996237372286288058L;
	/**
	 * id
	 */
	private Integer id;
