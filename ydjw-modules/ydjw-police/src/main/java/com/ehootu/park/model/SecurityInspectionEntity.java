 ...
 */
public class SecurityInspectionEntity implements Serializable {
	...
	//督促整改
	private String superviseAndReform;
	//图片
	private String workingPicture;
	//四巡平台(第三方链接)
	private String fourPatrolPlatform;
	//闪存平台(第三方链接)
	private String flashMemotyPlatform;
	//警察id
	 ...
	 * 设置：督促整改
	 */
	public void setSuperviseAndReform(String superviseAndReform) {
		this.superviseAndReform = superviseAndReform;
	}
	/**
	 * 获取：督促整改
	 */
	public String getSuperviseAndReform() {
		return superviseAndReform;
	}
	/**
	 * 设置：四巡平台(第三方链接)
	 */
	 ...
	 * 设置：闪存平台(第三方链接)
	 */
	public void setFlashMemotyPlatform(String flashMemotyPlatform) {
		this.flashMemotyPlatform = flashMemotyPlatform;
	}
	/**
	 * 获取：闪存平台(第三方链接)
	 */
	public String getFlashMemotyPlatform() {
		return flashMemotyPlatform;
	}
	/**
	 * 设置：图片
	 */
