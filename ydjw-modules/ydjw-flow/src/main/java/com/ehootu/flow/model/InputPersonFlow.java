...
public class InputPersonFlow implements Serializable {
	 ...
	 * 申请时间 标志 1 一周内 2一个月内
	 */
	private String  inputTimeFlog;
	/**
	 * 审核时间标志 1 一周内 2一个月内
	 */
	private String  approvalTimeFlog;
...
//	private Date approvalTime;
	...
	public String getInputTimeFlog() {
		return inputTimeFlog;
	}

	public void setInputTimeFlog(String inputTimeFlog) {
		this.inputTimeFlog = inputTimeFlog;
	}

	public String getApprovalTimeFlog() {
		return approvalTimeFlog;
	}

	public void setApprovalTimeFlog(String approvalTimeFlog) {
		this.approvalTimeFlog = approvalTimeFlog;
	}
