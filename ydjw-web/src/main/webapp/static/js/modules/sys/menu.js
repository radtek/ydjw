...
var vm = new Vue({
    ...
    methods: {
        getMenu: function(){
            //加载菜单树
            $.get(baseURL + "sys/sysmenu/select", function(r){
        ...
        saveOrUpdate: function () {
            ...
            var url = vm.menu.menuId == null ? "sys/sysmenu/save" : "sys/sysmenu/update";
            $.ajax({
                type: "POST",
                url: baseURL + url,
...
$(function () {
    ...
    var table = new TreeTable(Menu.id, baseURL + "sys/sysmenu/list", colunms);
